...
import { editProfileModal } from '../../../src/redux/slice';
      ...
      >
        <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}>
          <Stack flexDirection={'column'} gap={1}>
            <Typography variant="h2" fontWeight={'bold'} fontSize={_300 ? '1rem' : '0.8rem'}>
              Aditya_5001
            </Typography>
            <Stack flexDirection={'row'} alignItems={'center'} gap={1}>
              <Typography variant="h2" fontSize={_300 ? '2rem' : '1rem'}>
                {' '}
                Aditya_5001
              </Typography>
              <Chip
